...
from .models import Category, Group, Product, Image, Comment,AttributeKey, AttributeValue, ProductAttribute
...
class ProductAttributeSerializer(serializers.ModelSerializer):
    key_name = serializers.CharField(source='attr_key.key_name')
    value_name = serializers.CharField(source='attr_value.value_name')

    class Meta:
        model = ProductAttribute
        fields = ['id', 'key_name', 'value_name', 'product']
